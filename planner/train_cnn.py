...
def train(args):
    ...
    train_data = load_data('data_2/train', transform=transform, num_workers=4,  batch_size=args.batch_size)
    valid_data = load_data('data_2/valid', transform=transform, num_workers=4, batch_size=16)
